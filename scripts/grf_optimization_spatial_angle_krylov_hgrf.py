...
if args.load_path is None:
    ...
    solver = pynoisy.forward.HGRFSolver(args.nx, args.ny, diffusion_true, args.solver_type, seed=args.seed)
    measurements = solver.run(args.maxiter, num_frames=args.nt)
else:
...
adjoint_fn = forward_fn = lambda source: solver.run(source=source, maxiter=args.maxiter)
